...
const BENEFITS = [
  ...
  { icon: DollarSign, title: "Flexible USD Pricing", desc: "Set your own prices in USD. Maximize profit with competitive pricing in the Swiss market." },
  ...
  { icon: Tv, title: "19,000+ Channels", desc: "Full access to all channels including Swiss SRF, RTS, RSI plus international content." },
...
const PLANS = [
  { credits: 5, price: "$129", label: "Demo Panel", popular: false },
  { credits: 10, price: "$230", label: "Growth", popular: true },
  { credits: 15, price: "$279", label: "Business", popular: false },
  { credits: 20, price: "$329", label: "Enterprise", popular: false },
];
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background-base)] pt-24 pb-20">
      <div className="container mx-auto px-4 md:px-8 text-center mb-16">
        ...
        <p className="text-neutral-400 text-base md:text-lg max-w-2xl mx-auto mb-8">Start your own IPTV business in Switzerland. Get your reseller panel, manage customers, set USD prices, and earn profit with every subscription.</p>
      ...
      <div className="container mx-auto px-4 md:px-8 mb-16">
        <h2 className="text-2xl md:text-3xl font-bold text-white text-center mb-10">Reseller Plans (USD)</h2>
          ...
          {PLANS.map((plan, idx) => (
            <div key={idx} className={`relative bg-[var(--color-background-surface)] border rounded-2xl p-6 flex flex-col transition-all ${plan.popular ? "border-[var(--color-brand-primary)] ring-1 ring-[var(--color-brand-primary)]/40" : "border-white/10 hover:border-white/20"}`}>
              ...
              <div className="space-y-2.5 mb-6 flex-1">
                {["Full channel range", "White-label options", "Customer management", "USD pricing"].map((f, fIdx) => (
