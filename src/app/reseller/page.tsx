...
export const metadata: Metadata = {
  ...
  description: "Start your own IPTV business in Switzerland with our reseller program. White-label options, flexible pricing, full channel range. Demo panel from $129.",
