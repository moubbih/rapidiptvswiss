...
export const metadata: Metadata = {
  ...
  description:
    "Premium IPTV in Bern with 19,000+ channels in 4K. Watch BSC Young Boys, SRF, and Swiss sports live. Plans from $6.08/mo. Fast setup on any device.",
...
export default function IPTVBernPage() {
  const localSchema = {
    ...
    description:
      "Premium IPTV service provider serving Bern, Switzerland with 19,000+ live channels, movies, and series.",
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background-base)] pt-32 pb-16">
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-4xl">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold text-white mt-12 mb-6">
          IPTV Plans from $6.08 per Month
        </h2>
        <p className="text-[var(--color-text-secondary)] mb-6 leading-relaxed">
          Premium IPTV does not have to be expensive. Our annual plan starts at just $6.08 per month, giving you access to 19,000+ channels, Video on Demand, catch-up TV, and EPG. We offer 3-month, 6-month, and 12-month subscriptions supporting up to 5 simultaneous devices.
        </p>
        <p className="text-[var(--color-text-secondary)] mb-6 leading-relaxed">
